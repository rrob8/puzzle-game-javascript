...
var __stateFlatten = [];
var __rowSize = 0;
var __columnSize = 0; // create puzzle array
...
var moveTo = function moveTo(where, who) {
  ...
  switch (where) {
    case "left":
      el.style.left = el.getBoundingClientRect().left + el.getBoundingClientRect().width - __puzzle.getBoundingClientRect().left + "px";
      __pointer.style.left = __pointer.getBoundingClientRect().left - __pointer.getBoundingClientRect().width - __puzzle.getBoundingClientRect().left + "px";
      break;
    ...
    case "top":
      el.style.top = el.getBoundingClientRect().top + el.getBoundingClientRect().height - __puzzle.getBoundingClientRect().top + "px";
      __pointer.style.top = __pointer.getBoundingClientRect().top - __pointer.getBoundingClientRect().height - __puzzle.getBoundingClientRect().top + "px";
      break;
...
var isGameOver = function isGameOver() {
  ...
  if (_.isEqual(whatIsGameStatus, __stateFlatten)) {
    setTimeout(function () {
      var isPlayAgain = confirm("Dracula, Moby Dick, find the horror novel for my next trick ");
...
var __puzzleGame = function __puzzleGame(row, col) {
...
var onLoadGameStart = function onLoadGameStart() {
  __puzzleGame(3, 3);
};

onLoadGameStart();
var btnALl = document.querySelectorAll(".control button");
